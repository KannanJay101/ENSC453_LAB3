...
// ==============================================================
`timescale 1ns/1ps
module kernel_gemm_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER          = 6'h08,
    ADDR_ISR          = 6'h0c,
    ADDR_ALPHA_DATA_0 = 6'h10,
    ADDR_ALPHA_CTRL   = 6'h14,
    ADDR_BETA_DATA_0  = 6'h18,
    ADDR_BETA_CTRL    = 6'h1c,
    ADDR_NI_DATA_0    = 6'h20,
    ADDR_NI_CTRL      = 6'h24,
    ADDR_NJ_DATA_0    = 6'h28,
    ADDR_NJ_CTRL      = 6'h2c,
    ADDR_NK_DATA_0    = 6'h30,
    ADDR_NK_CTRL      = 6'h34,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_NI_DATA_0: begin
                    rdata <= int_ni[31:0];
                end
                ADDR_NJ_DATA_0: begin
                    rdata <= int_nj[31:0];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_NI_DATA_0)
            int_ni[31:0] <= (WDATA[31:0] & wmask) | (int_ni[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_NJ_DATA_0)
            int_nj[31:0] <= (WDATA[31:0] & wmask) | (int_nj[31:0] & ~wmask);
    end
end
