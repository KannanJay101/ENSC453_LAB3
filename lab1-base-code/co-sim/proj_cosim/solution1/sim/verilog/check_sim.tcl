...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.kernel_gemm.autotvin_gmem0.dat"
         "c.kernel_gemm.autotvin_gmem1.dat"
         "c.kernel_gemm.autotvin_C.dat"
         "c.kernel_gemm.autotvin_A.dat"
         "c.kernel_gemm.autotvin_B.dat"
         "c.kernel_gemm.autotvin_alpha.dat"
         "c.kernel_gemm.autotvin_beta.dat"
         "c.kernel_gemm.autotvin_ni.dat"
         "c.kernel_gemm.autotvin_nj.dat"
         "c.kernel_gemm.autotvin_nk.dat"
         "c.kernel_gemm.autotvout_gmem0.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.kernel_gemm.autotvout_gmem0.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
