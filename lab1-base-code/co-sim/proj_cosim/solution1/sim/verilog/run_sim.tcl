...
if {[file isfile kernel_gemm.autotvin.dat]} {
	file delete -force kernel_gemm.autotvin.dat
}

if {[file isfile kernel_gemm.autotvout.dat]} {
	file delete -force kernel_gemm.autotvout.dat
}
