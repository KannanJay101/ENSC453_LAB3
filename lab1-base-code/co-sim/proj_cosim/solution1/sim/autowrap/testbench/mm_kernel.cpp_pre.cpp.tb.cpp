...
extern "C"
#endif
void apatb_kernel_gemm_ir(float *, float *, float *, float, float, int, int, int);
#ifdef __cplusplus
extern "C"
#endif
void kernel_gemm_hw_stub(float *C, float *A, float *B, float alpha, float beta, int ni, int nj, int nk){
kernel_gemm(C, A, B, alpha, beta, ni, nj, nk);
return ;
}
#ifdef __cplusplus
extern "C"
#endif
void apatb_kernel_gemm_sw(float *C, float *A, float *B, float alpha, float beta, int ni, int nj, int nk){
apatb_kernel_gemm_ir(C, A, B, alpha, beta, ni, nj, nk);
return ;
}
#endif
# 95 "/local-scratch/localhome/kja56/ENSC453_LAB3/lab1-base-code/co-sim/mm_kernel.cpp"
