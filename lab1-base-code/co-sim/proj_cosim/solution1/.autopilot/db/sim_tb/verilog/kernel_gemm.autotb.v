...
`define AUTOTB_DUT      kernel_gemm
`define AUTOTB_DUT_INST AESL_inst_kernel_gemm
`define AUTOTB_TOP      apatb_kernel_gemm_top
`define AUTOTB_LAT_RESULT_FILE "kernel_gemm.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "kernel_gemm.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_kernel_gemm_top
...
`define AUTOTB_TVIN_gmem0  "./c.kernel_gemm.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1  "./c.kernel_gemm.autotvin_gmem1.dat"
`define AUTOTB_TVIN_C  "./c.kernel_gemm.autotvin_C.dat"
`define AUTOTB_TVIN_A  "./c.kernel_gemm.autotvin_A.dat"
`define AUTOTB_TVIN_B  "./c.kernel_gemm.autotvin_B.dat"
`define AUTOTB_TVIN_alpha  "./c.kernel_gemm.autotvin_alpha.dat"
`define AUTOTB_TVIN_beta  "./c.kernel_gemm.autotvin_beta.dat"
`define AUTOTB_TVIN_ni  "./c.kernel_gemm.autotvin_ni.dat"
`define AUTOTB_TVIN_nj  "./c.kernel_gemm.autotvin_nj.dat"
`define AUTOTB_TVIN_nk  "./c.kernel_gemm.autotvin_nk.dat"
`define AUTOTB_TVIN_gmem0_out_wrapc  "./rtl.kernel_gemm.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "./rtl.kernel_gemm.autotvin_gmem1.dat"
`define AUTOTB_TVIN_C_out_wrapc  "./rtl.kernel_gemm.autotvin_C.dat"
`define AUTOTB_TVIN_A_out_wrapc  "./rtl.kernel_gemm.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "./rtl.kernel_gemm.autotvin_B.dat"
`define AUTOTB_TVIN_alpha_out_wrapc  "./rtl.kernel_gemm.autotvin_alpha.dat"
`define AUTOTB_TVIN_beta_out_wrapc  "./rtl.kernel_gemm.autotvin_beta.dat"
`define AUTOTB_TVIN_ni_out_wrapc  "./rtl.kernel_gemm.autotvin_ni.dat"
`define AUTOTB_TVIN_nj_out_wrapc  "./rtl.kernel_gemm.autotvin_nj.dat"
`define AUTOTB_TVIN_nk_out_wrapc  "./rtl.kernel_gemm.autotvin_nk.dat"
`define AUTOTB_TVOUT_gmem0  "./c.kernel_gemm.autotvout_gmem0.dat"
`define AUTOTB_TVOUT_gmem0_out_wrapc  "./impl_rtl.kernel_gemm.autotvout_gmem0.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 9651;
...
parameter LENGTH_ni = 1;
parameter LENGTH_nj = 1;
parameter LENGTH_nk = 1;
...
reg end_ni;
reg [31:0] size_ni;
reg [31:0] size_ni_backup;
reg end_nj;
reg [31:0] size_nj;
reg [31:0] size_nj_backup;
reg end_nk;
reg [31:0] size_nk;
reg [31:0] size_nk_backup;
